...
const rawNodes = [
  ...
  // Demand Planning
  {id:'forecast', label:'flbr_raw_forecast_** (UB Legacy)', grains:['Channel','Region','ASIN'], x:25+X_OFF, y:470, cat:'demand'},
  {id:'forecast_rf', label:'flbr_raw_forecast_** (Redfits)', grains:['Channel','Region','MSKU'], x:40+X_OFF, y:270, cat:'demand'},
  ...
  // Brand Management
  {id:'orders', label:'fact_order_item', grains:['ASIN','MSKU','Country'], x:760+X_OFF, y:695, cat:'brand'},
  {id:'returns', label:'fact_returns', grains:['ASIN','MSKU','Country'], x:935+X_OFF, y:635, cat:'brand'},
  {id:'sales', label:'ft_usd_sales', grains:['ASIN','MSKU','Country'], x:635+X_OFF, y:550, cat:'brand', stacked:true},
  {id:'rgm', label:'report_global_metrics', grains:['ASIN','Country'], x:820+X_OFF, y:270, cat:'brand', stacked:true},
  {id:'traffic', label:'SalesTrafficByChildAsin', grains:['ASIN','Country'], x:995+X_OFF, y:355, cat:'brand'},
  {id:'bsr', label:'keepa_bsr_uny', grains:['ASIN','Country'], x:995+X_OFF, y:180, cat:'brand'},
  {id:'ads', label:'fact_ads_data', grains:['ASIN','MSKU','Country'], x:895+X_OFF, y:510, cat:'brand'},

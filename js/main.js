...
function frame(){
  ...
  r_s_rgm.forEach(([a,b])=>drawRoad(a,b,9));
  ...
  drawBoothAt(r_s_rgm[0], (srgm_b1_entry+srgm_b1_exit)/2, 'SKU→ASIN', pillColors.SKU.text, pillColors.ASIN.text, 'ASIN');
  // Cars
  ...
  salesRGMBoothCars.forEach(c=>{c.update();c.draw();});
